...
export interface FullResponseData {
    ...
    modelName?: string; // ADDED: The name of the model that generated the response
    generatedMedia?: { mimeType: string; data: string }[]; // ADDED: AI generated media
    toolAttachments?: Attachment[]; // ADDED: Attachments generated by tools (e.g. Web Reader)
}
